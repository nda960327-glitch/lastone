  ...
  if (btnViewAllWords) {
    btnViewAllWords.addEventListener('click', () => {
      ...
      currentWords.forEach(w => {
        ...
        tr.innerHTML = `
          <td style="padding: 10px 8px; font-weight: 600; color: #a78bfa; word-break: break-word;">${w.word}</td>
...
if (posHintEl) posHintEl.classList.add('hidden');
    ...
    if (wordLength <= 5) {
        testWordEl.style.setProperty('font-size', '19vw', 'important');
    } else if (wordLength <= 7) {
        testWordEl.style.setProperty('font-size', '16vw', 'important');
    } else if (wordLength <= 9) {
        testWordEl.style.setProperty('font-size', '14.5vw', 'important');
